...
<p>
  Detailed yaml file with a few other validation scenarios can be found:{" "}
  <a href="/code/data-validation-pipeline-w-yaml-polars-yaml.yaml" target="_blank">
    here
  </a>
</p>
...
<p>
  Full Python filen be found:{" "}
  <a href="/code/data-validation-pipeline-w-yaml-polars-py.py" target="_blank">
    here
  </a>
</p>
